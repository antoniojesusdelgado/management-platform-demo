...
- [x] Buscador global accesible para personas, proyectos, tareas e incidencias
- [x] Acceso mediante botón y atajo `Ctrl/Cmd+K`
- [x] Resultados acotados por organización y permisos
- [x] Bandeja unificada de tareas, aprobaciones, SLA y avisos operativos
- [x] Elementos derivados de los módulos originales, sin duplicar estados
- [x] Validación responsive, accesibilidad, rendimiento y aislamiento RLS
...
`v1.6.0` incorpora búsqueda global, una bandeja personal de trabajo y enlaces
directos a cada entidad. La experiencia invitada deriva la información del
estado local y la autenticada aplica permisos y aislamiento de organización en
servidor.
