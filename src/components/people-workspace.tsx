...
export function PeopleWorkspace({ people, events, leaveRequests, pending = false, loadError, onCreate, onUpdate }: Props) {
  ...
  return <main className="workspace" id="main-content">
    <div className="page-heading"><div><p className="eyebrow">Equipo · directorio seguro</p><h1>Personal</h1><p className="lede">Perfiles sintéticos, membresías y disponibilidad derivada de Vacaciones, sin duplicar datos sensibles.</p></div><button className="button button-primary" type="button" onClick={openCreate}><IconPlus size={19} />Añadir perfil</button></div>
