...
export const PRODUCT_RELEASES = [
  ...
  { version: "1.8.2", title: "Más control sobre tu privacidad", summary: "Ahora puedes decidir si compartes métricas de uso, cambiar esa elección cuando quieras y eliminar tu cuenta desde el perfil.", publishedDate: "2026-08-12" },
